	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['sub my channel Now'], -60);
				case 7:
					addMoreText('read this ligma', -60);
				...
				// credTextShit.text = 'lol';
				// credTextShit.screenCenter();
				case 9:
					createCoolText([madness[0]]);
				// credTextShit.visible = true;
				case 11:
					addMoreText(madness[1]);
				// credTextShit.text += '\nlmao';
				case 12:
					deleteCoolText();
				// credTextShit.visible = false;
